...
public class SSHParamModel extends FileXmlConfigBase{
   ...
   */
  public SSHParamModel(String serverType,String host,int port,String userName,String password){
   ...
   * @param password 密码
   * @param fileServerType 文件服务器类型
   * @param passphrase 如果密码加密时，密码信息的解密密码
   * @param keyFile 本地密钥文件路径
   */
  public SSHParamModel(String serverType,String host,int port,String userName,String password,String passphrase,String keyFile){
    this.serverType=serverType;
    this.host=host;
    this.port=port;
    this.userName=userName;
