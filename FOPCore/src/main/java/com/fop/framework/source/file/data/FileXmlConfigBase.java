...
public abstract class FileXmlConfigBase {
  ...
  private static final HashMap<String,FileServerTypes>  serverTypeMap;
 ...
 /**sftp服务器类型*/
  ...
  public FileServerTypes getServerTypeEnum(){
    ...
    if(serverTypeMap.containsKey(serverType)){
      ...
      throw new FileRuntimeException(FileConstant.FILE_SERVER_TYPE_ERROR+serverType+FileConstant.CURR_SUPPORTED_TYPE+serverTypeMap.keySet());
    }
  }
